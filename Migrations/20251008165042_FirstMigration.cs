    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbExams", x => x.ExamId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbQuestions", x => x.QuestionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbSubmissions", x => x.SubmissionId);
                    table.ForeignKey(
                        name: "FK_TbSubmissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbSubmissions_TbExams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "TbExams",
                        principalColumn: "ExamId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbChoices", x => x.ChoiceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbSubmissions_ExamId",
                table: "TbSubmissions",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_TbSubmissions_UserId",
                table: "TbSubmissions",
                column: "UserId");
        }
